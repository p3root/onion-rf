...
class RFDevice:
    ...
    def __init__(self, gpio,
        ...
        self.rx_last_state = False

        self.gpio_ins = onionGpio.OnionGpio(gpio)
    ...
    def enable_tx(self):
        ...
        if not self.tx_enabled:
            ...
            self.gpio_ins.setOutputDirection(0)
    ...
    def disable_tx(self):
        ...
        if self.tx_enabled:
            ...
            self.gpio_ins.setInputDirection()
            self.tx_enabled = False
    ...
    def rx_poll_detection(self):
        ...
        if self.tx_enabled:
            ...
            curValue = self.gpio_ins.getValue()
            if curValue is not self.rx_last_state:
                self.rx_callback(self)
            self.rx_last_state = curValue

            _LOGGER.debug("Poll done enabled ("+ curValue +")")
